          ...
          <table id="mainTable" class="table table-bordered table-striped">
            ...
            <?php foreach($data as $item): ?>
                  <tr>
                      ...
                      <td><?php echo $item['total_order'] ; ?>
                     <br/> Amount: <?php echo $item['total'] ; ?></td>
                     <td><?php echo $item['success'] ; ?>
                   
                    <br/> Amount:<?php echo $item['sec'] ; ?></td>
                    <td><?php echo $item['cancelled'] ; ?>
                    
                     <br/> Amount:<?php echo $item['cancelamt'] ; ?></td>
                      <td><?php echo $item['cdiscount'] ; ?>
                     <?php
                        $total = $item['total'];
                        $dis = $item['discount'];
                        $subtotal = $total - $dis;
                    ?>
                    <br/> Amount:<?php echo $item['discount'] ; ?></td>
                    <td>Subtotal :<?php echo $subtotal ; ?>
