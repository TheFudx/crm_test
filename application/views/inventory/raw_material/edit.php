						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<?php 
										$js = 'id="productType" class="form-control"';
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label for="dailyrequired" >Daily Required Quantity</label>
									<input type="text" id="dailyrequired" name="dailyrequired" autocomplete="off" class="form-control"  value="<?= $data ['daily_required'] ?? '';?>" onkeypress="return isNumber(event)">
								</div>
							</div>
						</div>
