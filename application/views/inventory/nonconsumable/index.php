          ...
          <table id="mainTable" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th>Current Stock</th>
                <th>Unit</th>
                <th>Last Price ( <i class="fas fa-rupee-sign"></i> )</th>
                <th>Last Updated</th> 
                <th class=" text-center"><a href="<?php echo base_url('inventory/nonconsumable_create') ?>" class="btn btn-default">Add New</a></th>
              </tr>
            </thead>
            ...
            <?php if ($data) :  $i = 1; ?>
                ...
                { ?> 
                  <tr>
                    ...
                    <td>  <?php if($row['current_stock'] == 'Not Available'){
                      echo '<b>'.$row['current_stock'].'</b>';
                    }else{
                      echo $row['current_stock'];
                    }?> - <?php echo $row['units'];?></td>
                    <td><?php echo $row['units'];?></td>
                    <td><?php 
                    if($row['price'] == 'Not Taken'){
                      echo '<b>'.$row['price'].'</b>';
                    }else{
                      echo $row['price'];
                    }
...
<div id="payNowModal" class="modal fade" role="dialog" data-keyboard="true" data-backdrop="static" tabindex="-1">
  <div class="modal-dialog ">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Non Consumable</h4>
      </div>
      <div class="modal-body" style="overflow: auto;">
        <div class="main-grid">
