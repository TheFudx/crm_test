          ...
          <table id="mainTable" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th class=" text-center"><a href="<?php echo base_url('purchase/create') ?>" class="btn btn-default">Add New</a></th>
              </tr>
            </thead>
              ...
              <?php if ($data) : 
                ...
                foreach($data as $row) { ?> 
                  <tr>
                    ...
                    <td class=" text-center"><?php echo $row['discount_amount'];?></td>
                    <td class=" text-center"><?php echo $row['pay_remark'];?></td>
                    <td nowrap class=" text-center">
                      <?php if ($row['ptype']== 'Fully Paid'){
                        echo "No Action";
                      }elseif($row['ptype']== 'Discount'){
                        echo "No Action";
                      }else{?>
