            ...
            <?php if ($data) : 
                ...
                <?php foreach ($data as $PaymentDetail){?>
                  <tr>
                    ...
                    <td><?php echo $PaymentDetail['invoiceDate'] ; ?> </td>
                    <td><?php echo $PaymentDetail['createdName'] ; ?> </td>
                    <td><?php echo $PaymentDetail['billAmount'] ; ?> </td>
                    <td nowrap>
                        ...
                        data-customer_id="<?= $PaymentDetail['customer_id']; ?>"
                        >Pay Now</button>
                    </td>
                  </tr>
                <?php } ?>
      ...
      <div class="modal-body" style="overflow: auto;">
        <div class="main-grid">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                  <input type="text" id="room" name="room" autocomplete="off" class="form-control" >
                </div>
            </div>
            <div class="row">
              <div class="col-sm-8">     
