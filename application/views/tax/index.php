          ...
          <table id="mainTable" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th>CGST</th>
                <th>Default</th>          
                <th class="text-center"><a href="<?php echo base_url('tax/create') ?>" class="btn btn-default">Add New</a></th>
              </tr>
            </thead>
                ...
                <?php foreach ($data as $k => $v) : ?>
                  <tr>
                    ...
                    <td nowrap class="text-center">
                      <button onClick="Edit(<?= $v['tax_id']; ?>)" class="btn"><i class="fas fa-pencil-alt edit__btn"></i></button>
                      <button onClick="Delete(<?= $v['tax_id']; ?>)" class="btn"><i class="fa fa-trash delete__btn" ></i></button>
                    </td>
                  </tr>
                <?php endforeach ?>
              <?php endif; ?>
