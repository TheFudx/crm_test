          ...
          <table id="mainTable" class="table table-bordered table-striped table-hover dataTable dtr-inline">
            <thead>
                <tr>
                    ...
                    <?php } ?> 
                    <th>Heading</th>
                    <th>Purpose of Cash Out</th>
                    <th>Reason</th>
                    <th>Amount</th>
                    <th>Date</th>
                    <th class="text-center"><a href="<?php echo base_url('expense/create') ?>" class="btn btn-default">Add New</a></th>
                </tr>
            </thead>
              ...
              <?php if ($data) : 
                ...
                foreach ($data as $k => $user_s) : ?>
                  <tr>
                    ...
                    <?php } ?> 
                    <td><?php if(!empty($user_s['master_heading'])){
                      echo $user_s['master_heading'];
                    }else{
                      echo "Not Available";
                    }    ?></td>
                    <td><?php if(!empty($user_s['purpose_cashout'])){
                      echo $user_s['purpose_cashout'];
                    }else{
                      echo "Not Available";
                    }    ?></td>
