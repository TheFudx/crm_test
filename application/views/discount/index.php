          ...
          <table id="mainTable" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th>Discount Name</th>
                <th>Discount</th>                                                       
                <th class="text-center"><a href="<?php echo base_url('discount/create') ?>" class="btn btn-default">Add New</a></th>
              </tr>
            </thead>
                ...
                <?php foreach ($data as $k => $v) : ?>
                  <tr>
                    ...
                    <td nowrap class="text-center">
                      <button onClick="Edit(<?= $v['discount_id']; ?>)" class="btn"><i class="fas fa-pencil-alt edit__btn"></i></button>
                      <button onClick="Delete(<?= $v['discount_id']; ?>)" class="btn"><i class="fa fa-trash delete__btn" ></i></button>
                    </td>
                  </tr>
                <?php endforeach ?>
              <?php endif; ?>
