          ...
          <table id="mainTable" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>Sr No</th>
                <th>Category Name</th>
                <th class="text-center"><a href="<?php echo base_url('category/create') ?>" class="btn btn-default">Add New</a></th>
              </tr>
            </thead>
                ...
                <?php foreach ($data as $k => $v) : ?>
                  <tr>
                    ...
                    <td nowrap class="text-center">
                      <button onClick="Edit(<?= $v['category_id']; ?>)" class="btn "><i class="fas fa-pencil-alt edit__btn"></i></button>
                      <button onClick="Delete(<?= $v['category_id']; ?>)" class="btn "><i class="fa fa-trash delete__btn" ></i></button>
                    </td>
                  </tr>
                <?php endforeach ?>
              <?php endif; ?>
