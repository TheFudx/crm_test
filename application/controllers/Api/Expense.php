...
class Expense extends REST_Controller {
    ...
    public function save_post(){
        ...
        $this->form_validation->set_rules('master_heading', 'Master Heading', 'trim');
        $this->form_validation->set_rules('purpose_cashout', 'Purpose of Cash Out', 'trim');
        $this->form_validation->set_rules('flow', 'flow', 'required|trim');
        ...
        if ($this->form_validation->run()) {
            ...
            $data['master_heading']     = $this->input->post("master_heading");
            $data['purpose_cashout']    = $this->input->post("purpose_cashout");
