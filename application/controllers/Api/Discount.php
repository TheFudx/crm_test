...
class Discount extends REST_Controller {
    ...
    public function save_post(){
        ...
        $this->form_validation->set_rules('discount_name', 'Discount Name', 'required|trim');
        $this->form_validation->set_rules('discount', 'Discount Percentage', 'required|trim|numeric');
        ...
        if ($this->form_validation->run()) {
            ...
            $result             = $this->Discountmodel->save($data, $main_id);
            $this->response([
                'validate' => TRUE,
    ...
    public function delete_post(){ 
        ...
        if ($this->form_validation->run()) {
            ...
            $delete = $this->Discountmodel->delete($id);
            $this->response([
